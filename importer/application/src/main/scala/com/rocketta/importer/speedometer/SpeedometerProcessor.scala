...
import com.rocketta.importer.core.{Sink, WithSinkFor}
import com.rocketta.importer.kafkastreams.KafkaStreamsProcessor
import org.apache.kafka.streams.StreamsBuilder
import org.apache.kafka.streams.kstream.KStream

final class SpeedometerProcessor(sink: Sink[Speed]) extends KafkaStreamsProcessor[Speed] with WithSinkFor[Speed] {
